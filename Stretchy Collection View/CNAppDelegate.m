...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	// Add the stretchy view controller
	CNStretchyCollectionViewFlowLayout *layout = [[CNStretchyCollectionViewFlowLayout alloc] init];
	CNStretchyCollectionViewController *stretchyVC = [[CNStretchyCollectionViewController alloc] initWithCollectionViewLayout:layout];
	self.window.rootViewController = stretchyVC;
